...
import { camera, scene, box, helloCircle, modelPixel, pixelSize, ModelInfo } from '@/Script/ThreeInit.js';
...
export default function Aniscroll(_target) {
    ...
    if(dom.id == 'hello') {
        ...
        // .to(pixelSize, {duration: 0, s: 15}, 'reset')
        // .to(ModelInfo.r, {duration: 0, y : 0.8}, 'reset')
        ...
        // 옆으로 구르는 모션
        .to(ModelInfo.p, {duration: 0.8, x: -0.3}, 'st1')
        .to(ModelInfo.r, {duration: 0.4, y: -6, z: 0}, 'st1')
        ...
        // 얼굴커지는 장면
        t1.to(ModelInfo.p, {duration: 0.5, x: -0.15, z: 0.7, y: -0.25}, 'st2')
        .to(ModelInfo.r, {duration: 0.5, y: -12, z: -0.1}, 'st2')
        .to(helloCircle.position, {duration: 0.8, x:0, z:0.5}, 'st2')
