const DataBase = [
  ...
  },
  {
    ...
    mainDesc:
      "바이슈코 반응형웹 사이트 입니다.\n프론트의 구축 업무와 운영 업무을 맡아서 하였으며\nreact, typescript 기반으로 작업 되었습니다.\n회사 자체 프레임 워크 (풀스택 타입스크립트 프레임 워크) 이용 하여 타입 subset 이용하여 빠르게 컴포넌트 생성 및 페이지를 만들수 있었습니다.\n입사 하자마자 바로 혼자 구축 업무를 하게 되어 꽤 힘들었지만 문제 없이 오픈한 프로젝트 입니다.",
